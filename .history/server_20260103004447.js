...
// --- TAHAP 1: API ROUTES (Paling Atas agar tidak tertelan View) ---
...
// --- TAHAP 2: API ERROR HANDLER (Kembalikan JSON jika rute API salah) ---
app.all('/api/*', (req, res) => {
    res.status(404).json({
        success: false,
