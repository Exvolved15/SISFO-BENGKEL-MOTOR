...
app.use(async (req, res, next) => {
    ...
    try {
        ...
        if (token) {
            ...
            res.locals.user = currentUser; // User sekarang tersedia di Navbar EJS
        } else {
...
app.get('/', protect, (req, res) => {
  ...
  console.log("Navigasi Beranda - Role:", role);

  // Redirect sesuai role agar tidak logout
  ...
  // Jika role tidak dikenal, baru lempar ke login
  res.redirect('/login');
});
// 6. Handle 404
app.use((req, res) => {
