...
// --- A. RUTE PUBLIK (BISA DIAKSES SIAPAPUN) ---
app.use('/', authViewRoutes); // Login & Register

app.get('/about', (req, res) => {
    res.render('about', { title: 'Tentang Kami', activePage: 'about' });
});

// Landing Page / Overview (Pastikan rute '/' di viewRoutes tidak memakai protect)
app.use('/', viewRoutes); 
...
// --- C. RUTE VIEW DASHBOARD (BUTUH LOGIN) ---
