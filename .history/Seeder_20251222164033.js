...
const importData = async () => {
    try {
        ...
        console.log("✅ SEEDER SUCCESSFUL! Suku cadang dan Jasa telah diperbarui.");
        process.exit();
    } catch (error) {
