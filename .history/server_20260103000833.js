...
// 2. MIDDLEWARE KEAMANAN (HELMET FIX)
app.use(
    helmet({
        ...
        hsts: false // FIX: Disable HSTS to prevent ERR_SSL_PROTOCOL_ERROR on localhost
    })
);
...
// 4. ROUTES REGISTRATION (FIXED ORDER)
...
app.use('/', viewRoutes); // Home/Overview bypass protect
