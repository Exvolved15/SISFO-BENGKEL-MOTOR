...
const protect = async (req, res, next) => {
    ...
    try {
        ...
        // HAPUS `.select('-password')` karena model User kita sudah tidak menyimpan password
        // Atau, jika Anda masih ingin mengecualikan field (misalnya 'uid'), jangan campur dengan exclusion lainnya
