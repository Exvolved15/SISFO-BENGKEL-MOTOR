...
// 1. Menampilkan Semua Transaksi (Admin/Kasir)
...
// 2. Menampilkan Detail Transaksi tunggal
...
const trackStatusPublic = async (req, res) => {
    try {
        ...
        const job = await Job.findOne({ transactionId: transaction._id });
        res.render('transactions/public-status', {
            title: 'Status Servis', transaction, job, activePage: 'home', layout: 'layouts/main'
        });
    } catch (error) {
