...
exports.updateUserProfile = (req, res) => {
    // Di sini kita memanggil fungsi upload multer
    // FIX: Tambahkan 'async' di depan callback (err)
    upload(req, res, async (err) => { 
        ...
        try {
            ...
            // Sekarang 'await' ini sudah VALID karena sudah ada 'async' di atas
            ...
            // Navigasi otomatis kembali ke dashboard sesuai role
