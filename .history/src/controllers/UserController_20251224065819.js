...
const updateUserProfile = (req, res) => {
    upload(req, res, async (err) => {
        ...
        try {
            ...
            // Tambahkan parameter t agar browser tidak mengambil gambar dari cache
