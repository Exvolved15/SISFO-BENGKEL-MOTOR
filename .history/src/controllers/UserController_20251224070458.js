...
const updateUserProfile = (req, res) => {
    upload(req, res, async (err) => {
        ...
        try {
            // FIX: Ambil semua data baru dari form (bio, status, department)
            ...
            // Berikan parameter waktu (t) agar browser tidak mengambil gambar lama dari cache
            const successParam = "?update=success&t=" + Date.now();
            
            // REDIRECT BERDASARKAN ROLE (SINKRONISASI DASHBOARD)
