...
const updateJobStatus = async (req, res) => {
    ...
    try {
        // Jika Anda menggunakan model Transaction untuk riwayat kasir:
...
// 6. Tambah Item/Suku Cadang (Mekanik mengisi detail kerja saat servis berlangsung)
const addServiceItem = async (req, res) => {
    ...
    try {
        ...
        // Jika item adalah part, kurangi stok di sini juga jika mekanik menambah item manual
        if (item.isPart) {
        ...
        // Update Total Biaya Keseluruhan otomatis
...
const printReceipt = async (req, res) => {
    try {
        ...
        res.render('kasir/receipt', { 
            layout: false, // Clean layout khusus cetak
            job 
        });
    } catch (error) {
