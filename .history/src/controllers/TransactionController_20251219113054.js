...
const processTransactionLogic = async (reqBody, userCreator) => {
    ...
    // KITA HAPUS SESSION START TRANSACTION AGAR TIDAK ERROR DI LOCALHOST
    ...
    try {
        ...
        // Perhatikan: Kita tidak pakai array [{}] lagi, langsung object {}
        ...
        // Tidak ada rollback session, langsung lempar error
        throw error;
    }
};
