...
module.exports = {
    // FUNGSI LOGIKA (hanya mengembalikan data/throw error)
    processTransactionLogic, 
    
    // FUNGSI API (menggunakan logic, mengirim res.json)
    createTransactionApi, 
    
    // FUNGSI API LAINNYA
    getAllTransactions
    
    // Pastikan TIDAK ada 'createTransaction' jika Anda sudah menggantinya
};