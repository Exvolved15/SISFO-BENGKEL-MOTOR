...
exports.updateUserProfile = (req, res) => {
    upload(req, res, async (err) => {
        ...
        try {
            ...
            if (req.file) {
                // Simpan path yang bisa diakses publik (sesuai setting server.js)
                updateData.profileImage = '/uploads/profiles/' + req.file.filename;
            }
            
            await User.findByIdAndUpdate(req.params.id, updateData);
            // Redirect kembali ke dashboard agar foto langsung berubah
            res.redirect('/admin/dashboard'); // Kembali ke halaman sebelumnya
        } catch (error) {
