...
const Part = require('../models/Part'); // Untuk Update Stok
...
const processTransactionLogic = async (reqBody) => {
    ...
    // ... (Logika yang sama persis seperti di Langkah 14.2) ...
    // HAPUS SEMUA BARIS res.json() atau res.status() DI DALAM BAGIAN INI.
    // Ganti res.json(...) dengan return { transaction: newTransaction[0], details: savedDetails };
    ...
    try {
        ...
        // 2. BUAT HEADER TRANSAKSI
        // ... (Kode untuk membuat Transaction) ...
        
        // 3. PROSES DETAIL ITEM & Cek Stok
        // ... (Kode untuk looping itemDetails dan BulkWrite) ...
        ...
        // MENGEMBALIKAN DATA SETELAH BERHASIL (TIDAK MENGIRIM RESPONSE HTTP)
        return { 
            transaction: newTransaction[0], 
            details: savedDetails 
        };
        ...
        // Lempar error agar bisa ditangkap oleh pemanggil fungsi (API atau View Route)
        throw error; 
    }
};
