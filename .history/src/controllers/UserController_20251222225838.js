...
exports.updateUserProfile = (req, res) => {
    // Fungsi upload (Multer) menerima callback (err) => { ... }
    // Anda HARUS menambahkan 'async' sebelum (err) agar 'await' di dalamnya valid.
    upload(req, res, async (err) => { // <--- KUNCI PERBAIKAN DI SINI
        if (err) {
        ...
        try {
            ...
            // Sekarang 'await' ini sah karena sudah berada di dalam fungsi async
