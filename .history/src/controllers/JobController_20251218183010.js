    ...
    try {
        ...
        if (!customerName || !vehicleLicense) {
            return res.status(400).json({ 
                success: false, 
                message: "Nama pelanggan dan plat nomor wajib diisi!" 
            });
        }
        ...
        // 2. Validasi stok dan mapping detail item secara mendalam
        ...
        const newJob = await Job.create({
            ...
            transactionDetails: mappedDetails, // Menggunakan hasil mapping yang sudah divalidasi
            totalAmount: totalAmount || 0,
            status: 'pending'
        });

        // 4. Kirim respon sukses tunggal
