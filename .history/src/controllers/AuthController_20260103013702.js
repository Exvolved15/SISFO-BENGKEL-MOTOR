...
const loginAPI = async (req, res) => {
    try {
        ...
        // TAMBAHKAN VERIFIKASI BCRYPT
        const isMatch = await bcrypt.compare(password, user.password);
        // Jika user baru dari Firebase tidak punya password di Mongo, 
        // pastikan sistem sinkronisasi password Anda sudah berjalan. 
        // Jika belum ada bcrypt, sementara gunakan: if (user) { ... }
