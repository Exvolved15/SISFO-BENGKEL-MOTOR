...
const verifyToken = async (req, res) => {
    ...
    try {
       ...
       // --- ASUMSIKAN VERIFIKASI FIREBASE BERHASIL ---
        ...
        // const firebaseUid = 'qHA1qantZpcB35LzOMuks0AG5b83'; // Contoh UID Admin <--- HAPUS ATAU KOMEN BARIS INI
        // ---------------------------------------------
        const decodedToken = await admin.auth().verifyIdToken(idToken); // <--- UNKOMEN BARIS INI
        const firebaseUid = decodedToken.uid; // <--- UNKOMEN BARIS INI
        // ---------------------------------------------
