...
const createPartView = async (req, res, next) => {
    try {
        ...
        await Part.create({
            ...
            purchasePrice: parseFloat(purchasePrice), // Mengisi purchasePrice di Model
            sellingPrice: parseFloat(price),          // Memetakan 'price' dari form ke 'sellingPrice' di Model
            supplier: supplier || '-'
        });
        ...
        // Tangani Error Duplikat Kode Part
