...
// FIX: Pindahkan getProfitReport ke dalam struktur const agar bisa di-export seragam
const getProfitReport = async (req, res) => {
    try {
        ...
        res.render('admin/report', { title: 'Laporan Laba Rugi', report, user: req.user, activePage: 'reports' });
    } catch (error) { res.status(500).send(error.message); }
};
