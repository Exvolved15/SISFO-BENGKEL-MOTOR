...
const createPartView = async (req, res) => {
    try {
        // Ambil data sesuai atribut 'name' di form EJS
        const { name, code, purchasePrice, price, stock, supplier } = req.body;

        // Validasi agar Mongoose tidak melempar error 'Required'
        ...
        await Part.create({
            ...
            purchasePrice: parseFloat(purchasePrice), // Mapping Harga Beli
        ...
        if (error.code === 11000) msg = "Kode Part atau Nama sudah digunakan!";
