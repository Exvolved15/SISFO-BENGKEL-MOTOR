...
const createJob = async (req, res) => {
    try {
        // 1. Ambil data dari body. Pastikan nama variabel sesuai dengan 'id' di EJS
        const { 
            customerName, 
            vehicleLicense, 
            assignedTo, 
        ...
        // 2. Validasi manual untuk mencegah error 'undefined'
        ...
        // 3. Proses detail item dan validasi stok
