...
exports.getEditUserPage = async (req, res) => {
    try {
        ...
        res.render('users/edit', {
            title: 'Edit User',
            user: req.user, // User yang sedang login (admin)
            targetUser: userToEdit, // User yang akan diedit
            activePage: 'users'
        });
    } catch (error) {
...
exports.updateUser = async (req, res) => {
    try {
        ...
        await User.findByIdAndUpdate(req.params.id, { 
            ...
            email, 
            role, 
            department // Menambahkan keterangan bagian mana
        });
