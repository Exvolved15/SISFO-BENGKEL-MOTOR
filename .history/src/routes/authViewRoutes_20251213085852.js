...
// 1. NONAKTIFKAN LOGIN/REGISTER VIEWS (Arahkan ke Dashboard)
// Ganti router.get('/') (jika ada) dan router.get('/login')

// Route Utama (Dashboard)
router.get('/', (req, res) => {
    // Kita akan buat user dummy di sesi
    req.user = { 
        _id: 'dummyid12345', 
        name: 'User Dummy', 
        role: 'admin' // Tetapkan role agar bisa mengakses semua fitur
    };
    ...
    res.render('index', { 
        ...
        user: req.user,
        // Hapus layout: false jika ada di sini
    });
});
