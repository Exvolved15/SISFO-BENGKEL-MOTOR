...
// Endpoint untuk Form ADD
router.post('/api/parts/add', protect, restrictTo('admin'), PartController.createPartView);

// Endpoint untuk Tampilan EDIT (Sesuaikan dengan href di list.ejs)
router.get('/api/parts/:id/edit', protect, restrictTo('admin'), PartController.getEditPage);

// Endpoint untuk Proses UPDATE (PUT)
router.post('/api/parts/:id', protect, restrictTo('admin'), PartController.updatePart);
