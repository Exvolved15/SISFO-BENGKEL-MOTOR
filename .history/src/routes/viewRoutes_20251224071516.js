...
router.get('/', async (req, res) => {
    try {
        // Jangan tampilkan landing page jika sudah login
        if (req.cookies.jwt || req.user) return res.redirect('/dashboard-redirect');
        
        // AMBIL DATA STAFF (Lengkap dengan bio dan status)
        ...
        res.render('index', { 
            ...
            activePage: 'home',
            staffList: staff, // Data ini yang menggerakkan list di halaman depan
