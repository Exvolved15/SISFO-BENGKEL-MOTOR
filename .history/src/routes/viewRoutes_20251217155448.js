...
router.get('/transactions/add', protect, restrictTo('kasir', 'admin'), async (req, res) => {
    try {
        ...
        // 2. Ambil data item, pisahkan antara Suku Cadang (Part) dan Jasa (Service)
        // Pastikan field 'isPart' sesuai dengan yang ada di database Anda
        ...
        res.render('transactions/add', {
            ...
            activePage: 'transactions',
            mekaniks,
            parts,      // Ini yang akan mengisi dropdown Suku Cadang
            services    // Ini yang akan mengisi dropdown Jasa
        });
    } catch (error) {
