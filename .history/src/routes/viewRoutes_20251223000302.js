...
// Rute Halaman Utama (Landing Page / Overview)
router.get('/', async (req, res) => {
    try {
        // Kita tidak menggunakan middleware 'protect' di sini agar bisa diakses umum
        res.render('index', { 
            title: 'Selamat Datang di Sisfo Bengkel',
            layout: 'layouts/landing' // Opsional: Gunakan layout khusus jika ada
        });
    } catch (error) {
