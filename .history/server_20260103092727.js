...
app.use('/cashier/dashboard', protect, async (req, res) => {
    try {
        ...
        res.render('cashier/dashboard', { title: 'Kasir Dashboard', transactions, activePage: 'dashboard' });
    } catch (e) { res.status(500).send("Error Kasir Dashboard"); }
});
