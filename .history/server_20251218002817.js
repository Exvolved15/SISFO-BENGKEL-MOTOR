    ...
    helmet({
      contentSecurityPolicy: {
        directives: {
          ...
          "script-src-attr": ["'unsafe-inline'"], // TAMBAHKAN INI agar onclick jalan
          "connect-src": ["'self'", "http://localhost:5000", "https://identitytoolkit.googleapis.com", "https://*.googleapis.com"],
